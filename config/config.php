...
return [
    ...
    'obfuscate'           => env('UNITER1_OBFUSCATE', false),
    'projectDirectory'    => env('UNITER1_PROJECT_DIRECTORY', base_path()),
    ...
    'unitTestsDirectory'  => env('UNITER1_UNIT_TESTS_DIRECTORY', 'tests/Unit'),
    'inspectorMode'       => env('UNITER1_INSPECTOR_MODE', true),
    'useDependent'        => env('UNITER1_USE_DEPENDENT', false),
];
